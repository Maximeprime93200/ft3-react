...
import Timeline from '../../img/timeline4.png';
        ...
        <div className = "Step1">
            ...
            <div className = "Background">
                ...
                <div className = "Block2"> 
                    <h1 className = "title">Montant</h1>
                </div>
                <div className ="bar">
                    <input id="searchbar" onkeyup="search" type="text" name="search" placeholder="   Montant du virement"></input>
                </div>
                
                <Link className ="link" to ="/Step5">
                    <div className="button">
                        <p className="button2">Continuer</p>
                    </div>
                </Link>
            </div>
